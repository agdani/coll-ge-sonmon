...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Liste des niveaux d'études</span></h4>
    <a href="{{ route('dashboard.add_niveau_etude') }}" class="btn btn-primary text-white mb-3 mt-1 me-2">
                            ...
                            <table class="table table-bordered">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="text-truncate">Niveau étude</th>
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end m-0">
                                                    <a href="{{ route('dashboard.edit_niveau_etude', $item->id) }}"
                                                     class="dropdown-item text-dark delete-record">
                                                     <i class="mdi mdi-text-box-edit-outline text-warning me-2"></i>
                                                     Modifier
                                                    </a>

                                                    <a href="{{ route('dashboard.delete_new_niveau_etude', $item->id) }}"
                                                     class="dropdown-item text-dark delete-record">
